                    ...
                    <Box sx={{ width: '15%', flexShrink: 0, borderLeft: '1px solid rgba(0,0,0,0.05)', pl: 2 }}>
                        ...
                        <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
                            <Box>
                                ...
                                <Typography variant="body2" fontWeight={500}>{collaboration.type || '-'}</Typography>
                            </Box>

                            <Box>
                                <Typography variant="caption" color="text.secondary">Operacional</Typography>
                                <Typography variant="body2" fontWeight={500}>{collaboration.description?.attributes?.operacional || '-'}</Typography>
                            </Box>

                            <Box>
                                <Typography variant="caption" color="text.secondary">Responsable</Typography>
                                <Typography variant="body2" fontWeight={500}>{collaboration.description?.attributes?.responsable || '-'}</Typography>
                            </Box>

                            <Box>
                                <Typography variant="caption" color="text.secondary">Área de Negocio</Typography>
                                <Typography variant="body2" fontWeight={500}>{collaboration.description?.attributes?.areaNegocio || '-'}</Typography>
                            </Box>

                            <Box>
                                <Typography variant="caption" color="text.secondary">Jefe de Proyecto</Typography>
                                <Typography variant="body2" fontWeight={500}>{collaboration.description?.attributes?.jefeProyecto || '-'}</Typography>
                            </Box>
                                ...
                                <Box>
                                    {(collaboration.description?.attributes?.analistas || []).length > 0 ? (
                                        (collaboration.description.attributes.analistas || []).map(uid => {
                                            ...
                                            return (
                                                <Typography key={uid} variant="body2" fontWeight={500} sx={{ display: 'block' }}>
                                                    {user?.name || 'Usuario'}
                                                </Typography>
                                            );
                                        })
                            ...
                            <Box>
                                ...
                                <Typography variant="body2" fontWeight={500}>{collaboration.description?.attributes?.fechaNecesidad || '-'}</Typography>
                            </Box>
                        </Box>
                    </Box>
